...
const SLUG_MAP: Record<string, string> = {
  ...
  flip: "/pdf-tools/flip",
  "n-up": "/pdf-tools/n-up",
  "pages-per-sheet": "/pdf-tools/n-up",
  bates: "/pdf-tools/bates",
  "bates-numbering": "/pdf-tools/bates",
  ...
  "pdf-to-handwriting": "/pdf-tools/pdf-to-handwriting",
  handwriting: "/pdf-tools/pdf-to-handwriting",
  "scan-to-pdf": "/pdf-tools/scan-to-pdf",
  scan: "/pdf-tools/scan-to-pdf",
