...
import { ArrowDown, ArrowUp, Copy, Eye, FilePlus, Grid2X2, List, RotateCcw, RotateCw, Trash2 } from "lucide-react";
              ...
              >
                <div className="page-workspace-preview-wrap">
                  ...
                  >
                    ...
                    {page.thumbnail ? (
                      <img src={page.thumbnail} alt={`Preview of page ${page.pageIndex + 1}`} style={{ transform: `rotate(${page.rotation ?? 0}deg)` }} />
                    ) : (
                ...
                <div className="page-workspace-meta">
                  ...
                  <span>
                    {page.pageIndex < 0
                      ? `Blank A4${page.rotation ? ` · ${page.rotation}°` : ""}`
                      : `${page.sourceLabel ? `${page.sourceLabel} · ` : ""}Original ${page.pageIndex + 1}${page.rotation ? ` · ${page.rotation}°` : ""}`}
                  </span>
                </div>
                {onRotate || onRemove || onDuplicate || onInsertBlankAfter ? (
        ...
        <div className="page-preview-modal" role="dialog" aria-modal="true" aria-label={`Preview page ${previewIndex + 1}`} onMouseDown={(event) => {
          ...
          <div className="page-preview-dialog no-navigation">
            ...
            <div className="page-preview-stage">
              {/* Generated locally from the selected PDF. */}
              <img src={previewPage.thumbnail} alt={`Large preview of page ${previewPage.pageIndex + 1}`} style={{ transform: `rotate(${previewPage.rotation ?? 0}deg)` }} />
            </div>
          </div>
        </div>
      ) : null}
